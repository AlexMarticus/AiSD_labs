...
while task < 0 or task>100000:
    task = int(input("Введенное число не находится в диапазоне [1, 100000], введите заново число от 1 до 100000, которое необходимо найти:"))
right = len (nums)
mid = 0
